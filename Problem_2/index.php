...
<h2 align="center">Product Profile</h2>
        ...
        <tr>
            ...
            <td>
                <select name="productCategory" id="productCategory">
                    ...
                    <option value="Toys & Video Games">Toys & Video Games</option>
                </select>
            </td>
        </tr>
        <tr>
...
<footer align="center"><a href="productList.php">Go to Product List Page</a></footer>
