...
if(isset($_GET['insert'])){
    ?>
    <h2 align="center" style="color:green">Inserted successfully into the database</h2>
    <?php
}
?>
...
<form action="insertEmployee.php" method="post">
    <table align="center">
        ...
        <tr>
            <td>Gender:</td>
            <td>    
                <input type="radio" id="male" name="employeeGender" value="Male" style="width:10%">
                <label for="male">Male</label>    
                <input type="radio" id="female" name="employeeGender" value="Female" style="width:10%">
